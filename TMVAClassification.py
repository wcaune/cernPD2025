...
DEFAULT_INFNAME  = "analysis-sim-protons-tmva.root"
DEFAULT_TREESIG  = "spTree"
DEFAULT_TREEBKG  = "nspTree"
DEFAULT_METHODS  = "Cuts, KNN, Likelihood"
...
def main():
    ...
    dataloader.AddVariable( "_chit_avgev",  "Average Hit Energy", "GeV", 'F' )
    dataloader.AddVariable( "_chit_n",      "N hits in slice", "", 'F' )

    """
    dataloader.AddVariable( "_chit_E0frac", "Fraction of energy in last plane", "", 'F' )
    dataloader.AddVariable( "_chit_E1frac", "Fraction of energy in last-1 plane", "", 'F' )
    dataloader.AddVariable( "_chit_E2frac", "Fraction of energy in last-1 plane", "", 'F' )
    dataloader.AddVariable( "_chit_E3frac", "Fraction of energy in last-1 plane", "", 'F' )
    dataloader.AddVariable( "_chit_E4frac", "Fraction of energy in last-1 plane", "", 'F' )
    dataloader.AddVariable( "_chit_E5frac", "Fraction of energy in last-1 plane", "", 'F' )
    dataloader.AddVariable( "_chit_E6frac", "Fraction of energy in last-1 plane", "", 'F' )
    """
    
    dataloader.AddVariable( "_chit_ldr",    "Last hit dR", "cm",'F')
    dataloader.AddVariable( "_chit_ldx",    "Last hit dX", "cm",'F')
    dataloader.AddVariable( "_chit_ldy",    "Last hit dY", "cm",'F')

    """
    dataloader.AddVariable( "_chit_E0", "Energy in last plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E1", "Energy in last-1 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E2", "Energy in last-2 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E3", "Energy in last-3 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E4", "Energy in last-4 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E5", "Energy in last-5 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E6", "Energy in last-6 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E7", "Energy in last-7 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E8", "Energy in last-8 plane", "GeV", 'F' )
    dataloader.AddVariable( "_chit_E9", "Energy in last-9 plane", "GeV", 'F' )


    dataloader.AddVariable( "_chit_E0dR", "Last hit dR new", "", 'F' )
    dataloader.AddVariable( "_chit_E1dR", "Last-1 hit dR", "", 'F' )
    dataloader.AddVariable( "_chit_E2dR", "Last-2 hit dR", "", 'F' )
    dataloader.AddVariable( "_chit_E3dR", "Last-3 hit dR", "", 'F' )
    dataloader.AddVariable( "_chit_E4dR", "Last-4 hit dR", "", 'F' )
    dataloader.AddVariable( "_chit_E5dR", "Last-5 hit dR", "", 'F' )
    dataloader.AddVariable( "_chit_E6dR", "Last-6 hit dR", "", 'F' )
    """

    #dataloader.AddVariable( "_chit_lp",      "Last plane hit ", "",'F')
    # dataloader.AddVariable( "_chit_gev",  "Total Hit Energy", "GeV", 'F' )
    #dataloader.AddVariable( "_part_p", "Proton momentum (fudged)", "MeV",'F')
    #dataloader.AddVariable( "_part_y", "Proton x-entry ", "cm",'F')
    #dataloader.AddVariable( "_part_x", "Proton y-entry", "cm",'F')
    ...
    input.cd("testbeamtrackana")

    print("input: ")
    input.ls()

    # Get the signal and background trees for training
    signal = gDirectory.Get(treeNameSig)
    background  = gDirectory.Get( treeNameBkg )
    ...
    mycutSig = TCut( "!TMath::IsNaN(_chit_avgev) && !TMath::IsNaN(_chit_lpfrac)" ) 
    mycutBkg = TCut( "!TMath::IsNaN(_chit_avgev) && !TMath::IsNaN(_chit_lpfrac)" )
